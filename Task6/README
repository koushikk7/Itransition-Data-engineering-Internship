...
- Picking latitude uniformly causes clustering near the poles. To avoid that we:
  ...
  - This gives a constant probability per area on the sphere (no polar bias).
...
- Add a short example of the names/cities table schema,
- Include sample outputs,
- Or give a compact "how to add a new locale" section.
